...
def update_edges(method="sobel", image="building", low_filtering = True, low_filter_type = "gaussian", low_filtering_kernel_size = 5, 
          high_filtering = False, high_filter_type = "gaussian", high_filtering_kernel_size = 3, strength = 2.0, 
          threshold = True, block_size=11, constant=3,
          edge_threshold=30):
